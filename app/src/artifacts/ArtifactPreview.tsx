...
export function ArtifactPreview(props: { artifact: Artifact; mode?: ArtifactPresentationMode; threadId?: number | null; onDismiss?: () => void; onReturnToComposer?: () => void }) {
  ...
  </Show></Show>}><pre data-slot="artifact-source" class="min-h-full overflow-auto whitespace-pre p-4 font-mono text-sm text-foreground">{props.artifact.content}</pre></Show>;
}
