...
pub use hirsel_proto::{
    ...
    ProcessState, Thread, ThreadActivity, ThreadAttention, ThreadIcon, ThreadKind,
    ThreadRelatedItem, ThreadRelatedTarget, ThreadTurn, ThreadTurnState, ToolCallSummary,
};
