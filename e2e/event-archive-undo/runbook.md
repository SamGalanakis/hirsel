...
```bash
/workspace/code/hirsel-rbcov/e2e/event-archive-undo/run.sh
```

The runner sources `e2e/lib/runbook-lib.sh`, starts the prebuilt host from the neutral cwd, and uses
