...
mod thread_read;
pub(crate) use thread_archive::ArchiveOutcome;
    ...
    pub async fn reset(&self) -> anyhow::Result<()> {
        let mut conn = self.conn.lock().await;
        {
            ...
            tx.execute_batch(
                ...
                DELETE FROM thread_turn_contexts;
                ...
                DELETE FROM thread_change_deliveries;
                DELETE FROM thread_change_cursors;
