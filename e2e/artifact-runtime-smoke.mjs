...
try {
 ...
 console.log(JSON.stringify({solid:'2.0.0-rc.7',reactivity:true,editRefresh:true,parentStorageBlocked:true,backendFetchBlocked:true,webSocketBlocked:true,offline:true,sandbox,errors}));
