    ...
    <header class="mb-1 flex flex-col gap-1">
      ...
      <div class="relative flex items-center">
        ...
        <input type="search" aria-label="Search Spaces and Tasks" placeholder="Search…" value={query()} onInput={event => setQuery(event.currentTarget.value)}
          class="h-7 w-full min-w-0 rounded-md border border-border bg-transparent pl-7 pr-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring pointer-coarse:h-11" />
      </div>
    </header>
