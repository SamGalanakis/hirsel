...
describe("current history boundary", () => {
  ...
  it("reconciles a turn that finishes while a same-history connection is offline", async () => {
    ...
    const running = { requester_thread_id: null, requester_turn_id: null, id: 1, thread_id: 1, state: "running" as const, owner_message_id: owner.id, agent_message_id: null, accepted_at: owner.ts, started_at: owner.ts, finished_at: null };
    ...
    first.serverSend({ type: "thread_opened", client_id: firstOpen.client_id, detail: { thread, brief: { text: "", artifact_ids: [] }, messages: [owner], turns: [running], effects: [], turn_timelines: [], activities: [], related_items: [], grants: [], has_more: false } });
    ...
    reconnected.serverSend({ type: "thread_opened", client_id: reconnectOpen.client_id, detail: { thread: makeThread(1, { last_finished_turn: completed }), brief: { text: "", artifact_ids: [] }, messages: [owner, final], turns: [completed], effects: [], turn_timelines: [], activities: [], related_items: [], grants: [], has_more: false } });
