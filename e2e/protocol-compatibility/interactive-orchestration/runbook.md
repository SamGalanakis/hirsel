...
helpers from `e2e/protocol-compatibility/lib/runbook-lib.sh`.
...
Per `e2e/protocol-compatibility/RULES.md`: record the process ids, the idle-before-terminal broadcast ordering, the warm
