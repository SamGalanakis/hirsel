...
that selected Thread through its action menu, and reconciles the Space-chat landing,
remembered Space, browser draft, authenticated history, Archived inventory,
...
the selected conversation; the archive returns to the owning Space chat while
