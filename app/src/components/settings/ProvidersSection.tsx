...
/** Whether Native execution defaults to this instance. A quiet marker, not a
 * control: the provider and model live in Agents, and this only answers "which
 * of these is it using?". */
function hostsNative(instance: ProviderInstance): boolean {
  return state.model?.provider_id === instance.id;
}
          ...
          <div class="flex items-start justify-between gap-3">
            <div class="min-w-0 flex-1">
              <div class="flex min-w-0 items-center gap-2">
                ...
                <Show when={hostsNative(props.instance)}>
