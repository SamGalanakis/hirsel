...
No scaffold deviation currently blocks the slice-1 Lash embedding target. Prompt quality and product behavior can still need tuning after real LLM runs, especially around when the Agent chooses Inbox vs Chat.
