...
Prove the host survives a restart onto an EXISTING data dir — the ordinary restart path every fresh-boot runbook misses. Regression guard for `store_commit_failed: runtime turn host-queue-drain:N ... already committed` (drain replay keys colliding across boots, found live 2026-07-09).
